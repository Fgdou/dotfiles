{
  ...
  home-manager.users.fgdou = {
    ...
    dconf = {
      ...
      settings."org/cinnamon/desktop/background".picture-uri = "file:///home/fgdou/dotfiles/assets/Wolf.jpg";
      settings."org/cinnamon" = {
      ...
      settings."org/nemo/preferences".show-hidden-files = "true";
      settings."org/x/apps/portal".color-scheme = "prefer-dark";
      settings."org/cinnamon/desktop/background".picture-options = "zoom";
    };
  };
}